<div class="row" ng-app="Common_app" ng-controller="Stock_of_store_controller">
    <div class="col-lg-10 col-xs-offset-1">
        <div class="panel panel-info">
            <div class="panel-heading">
                <div class="panel-title">Store's Product Stock  <span class="store-code"><?php if($this->session->userdata('store_code')){ echo "- "; echo $this->session->userdata('store_code');} ?></span>
				</div>
            </div>
                ...
                <div class="row">   
                    ...
                    <div class="col-lg-12" ng-show="filter_data > 0">
                        <table class="table table-striped table-bordered" datatable="ng">
                            ...
                            <tbody>
                                <tr ng-repeat="data in searched = (stock_of_store | filter:search | orderBy : base :reverse) | beginning_data:(current_grid-1)*data_limit | limitTo:data_limit" ng-class="{'disable':data.status==0}">
                                    ...
                                    <td >
										...
										<span ng-if="data.quantity>0" >{{data.quantity}}</td>  
                                    <td><span style="text-transform: lowercase;">{{data.uom}}</span>
									</td> 
                                </tr>
                            </tbody>
                        </table>
